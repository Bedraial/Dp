...
return(
<div className='Term'>
<center><h1>Terminos y condiciones</h1>
<h4>Al aceptar los terminos y condiciones acepta el manejo de sus datos con la finalidad de contactarlo y/o generar una de las varios tipos de reservas.<br/>
D'paseo.col no compartira informacion sin su debido conociento,los datos que usted comparta seran los utilizados bajo la autorizacion brindada al aceptar terminos y condiciones.<br/>
La empresa D'paseo.col se rigue de manera extricta bajo la ley de proteccion de datos colombiana o ley 1581 de 2012.<br/>
Teniendo en cuenta los principios de finalidad,libertad,calidad y transparecia para con el usuario y la seguridad de los datos del mismo<br/>
